...
interface DelegationAwareATokenInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "DelegateUnderlyingTo(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DelegateUnderlyingTo"): EventFragment;
...
export type DelegateUnderlyingToEvent = TypedEvent<
...
export class DelegationAwareAToken extends BaseContract {
  ...
  filters: {
    ...
    ): TypedEventFilter<[string], { delegatee: string }>;
