...
interface IncentivizedERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class IncentivizedERC20 extends BaseContract {
  ...
  interface: IncentivizedERC20Interface;
