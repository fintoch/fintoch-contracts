...
interface MintableDelegationERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class MintableDelegationERC20 extends BaseContract {
  ...
  interface: MintableDelegationERC20Interface;
