...
interface MintableIncentivizedERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class MintableIncentivizedERC20 extends BaseContract {
  ...
  interface: MintableIncentivizedERC20Interface;
