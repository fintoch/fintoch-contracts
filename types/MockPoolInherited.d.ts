...
interface MockPoolInheritedInterface extends ethers.utils.Interface {
  functions: {
...
export class MockPoolInherited extends BaseContract {
  ...
  functions: {
    ...
    setMaxNumberOfReserves(
      newMaxNumberOfReserves: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
