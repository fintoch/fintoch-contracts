...
import type {
  ...
  IPriceOracleSentinelInterface,
} from "../IPriceOracleSentinel";
...
export class IPriceOracleSentinel__factory {
  static readonly abi = _abi;
  static createInterface(): IPriceOracleSentinelInterface {
    return new utils.Interface(_abi) as IPriceOracleSentinelInterface;
  }
  static connect(
    address: string,
