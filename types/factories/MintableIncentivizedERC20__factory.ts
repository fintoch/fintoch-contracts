...
import type {
  ...
  MintableIncentivizedERC20Interface,
...
export class MintableIncentivizedERC20__factory {
  static readonly abi = _abi;
  static createInterface(): MintableIncentivizedERC20Interface {
    return new utils.Interface(_abi) as MintableIncentivizedERC20Interface;
  }
  static connect(
    address: string,
